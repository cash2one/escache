...
public class FreeMarkerUtils {  
    ...
    /** 应用所在路径 */  
    private static String appPath =  ClassLoader.getSystemClassLoader().getResource("templates").getPath();
    ...
    static {
      ...
      * @return
      */
    public static String getDSL(Map<String, Object> data, String templateFileName) {  
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.print(getDSL(data,"test.ftl"));
